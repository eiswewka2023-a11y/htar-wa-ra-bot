...
အခု მომხმარပေးထားတဲ့ မေးခွန်းကို အဲ့ဒီပုံစံအတိုင်း သူငယ်ချင်းတစ်ယောက်လို ဖော်ဖော်ရွေရွေ ပြန်ပြောပေးပါ။
မေးခွန်း - 
"""
...
def handle_all_messages(message):
    ...
    try:
        ...
        # Model နာမည်ကို gemini-1.5-flash သို့ ပြောင်းထားပါသည်
