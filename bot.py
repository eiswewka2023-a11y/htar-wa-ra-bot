...
မင်းက "ထာဝရ" မိတ္တူ၊ ဓါတ်ပုံ၊ ဖိတ်စာ၊ ယပ်တောင်၊ Mini keychain လုပ်ငန်း (ဖုန်းနံပါတ် - +959797523108) မှာ အလုပ်လုပ်နေတဲ့ မိတ်ဆွေတစ်ယောက်လို စကားပြောပါတယ်။
စာနဲ့ ဓါတ်ပုံထုတ်တာတွေ၊ ဖိတ်စာနဲ့ ပတ်သက်လာရင် ကျွမ်းကျင်သူတစ်ယောက်လို အကြံပေးတတ်တယ်၊ ပြင်ဆင်ပေးတတ်တယ်။

ဆိုင်ဖွင့်ရက် အချက်အလက်:
• ဆိုင်က တနင်္လာနေ့မှ စနေနေ့အထိ (တစ်ပတ်လျှင် ၅ ရက် သို့မဟုတ် ၆ ရက်) ဖွင့်လှစ်ပါသည်။ ဆိုင်ဖွင့်ရက်/အချိန်မေးပါက ဒီအချက်အလက်ကို မူတည်ပြီး ရင်းနှီးစွာ ပြန်ဖြေပေးပါ။

အရေးကြီးသော စည်းကမ်းချက်:
• စာပြန်သည့်အခါ အရှည်ကြီး မရေးရပါ။
• စာပြန်သည့်အခါ "သူငယ်ချင်း" ဟု မသုံးရပါ။ "မိတ်ဆွေ" ဟုသာ သုံးရပါမည်။
• စကားပြောသူ၏ စကားပြောပုံစံပေါ်မူတည်၍ လိုက်ရောညီထွေရှိစွာ လိုက်ပါပြောဆိုပါ၊ သင့်တော်သော Emoji လေးများ (😊📅✨) ထည့်သုံးပါ။
• လိုရင်းတိုရှင်း တိုတိုတုပ်တုပ်ပဲ စာကြောင်း ၄ ကြောင်း သို့မဟုတ် ၅ ကြောင်းထက် မပိုဘဲ ပြန်ဖြေပေးပါ။
"""
...
def send_welcome(message):
    ...
    welcome_text = (
        "မင်္ဂလာပါ မိတ်ဆွေရေ... 'ထာဝရ' မှ ကြိုဆိုပါတယ်! 👋✨\n\n"
...
def handle_incoming_photo(message):
    ...
    bot.send_message(
        chat_id, 
        "ဓါတ်ပုံလေး ရရှိပါတယ် မိတ်ဆွေ! 📸 'ထာဝရ' မှ စစ်ဆေးပြီး အမြန်ဆုံး ပြန်လည် အကြောင်းပြန်ပေးပါမယ်နော်။ ✨", 
        parse_mode="Markdown",
...
def handle_all_messages(message):
    ...
    if user_text == "💬 စကားပြောမယ်":
        ...
        bot.send_message(
            chat_id, 
            "အိုကေ မိတ်ဆွေ! အခု AI နဲ့ စကားပြောနိုင်တဲ့ Mode ထဲ ရောက်ပါပြီ။ သိချင်တာ သို့မဟုတ် မေးချင်တာတွေကို ရိုက်မေးနိုင်ပါပြီနော်။ 🤖✨", 
            reply_markup=get_main_menu()
        )
        return
        ...
        services_caption = (
            ...
            "လိုချင်တဲ့ ပုံစံလေးတွေရှိရင် စာပို့ပြီး မေးမြန်းနိုင်ပါတယ် မိတ်ဆွေ! 😊"
        )
        ...
        bot.send_message(
            chat_id, 
            "အထက်ပါ ဝန်ဆောင်မှုများနှင့် ပတ်သက်၍ အသေးစိတ် သိရှိလိုပါက မေးမြန်းနိုင်ပါတယ် မိတ်ဆွေ! 👇", 
            reply_markup=get_main_menu()
        )
        return
        ...
        location = (
            ...
            "📞 **ဆက်သွယ်ရန် ဖုန်း:** +959797523108\n"
            "📅 **ဆိုင်ဖွင့်ရက်:** တနင်္လာ မှ စနေနေ့ အထိ (၁ ပတ်လျှင် ၅ ရက် ~ ၆ ရက်)\n\n"
            "'ထာဝရ' မိတ္တူ/ဓါတ်ပုံ/ဖိတ်စာဆိုင်မှ နွေးထွေးစွာကြိုဆိုပါတယ် မိတ်ဆွေရေ! 😊"
        )
        ...
        bot.send_message(
            chat_id, 
            "ထာဝရ အတွက် အကြံပြုချင်တာ သို့မဟုတ် ပြင်ဆင်စေချင်တာလေးတွေရှိရင် စာရိုက်ပြီး ပို့ပေးခဲ့ပါဦးနော် မိတ်ဆွေ... ✍️✨", 
            reply_markup=get_main_menu()
        )
        return
    ...
    if current_state == "CHAT_WITH_ADMIN":
        ...
        bot.send_message(chat_id, "ဆိုင်သို့ စာပို့လိုက်ပါပြီ မိတ်ဆွေ! ဆိုင်မှ အကြောင်းပြန်ပေးပါလိမ့်မည်။ ❤️", reply_markup=get_main_menu())
        return
    ...
    if current_state == "WAITING_FOR_FEEDBACK":
        ...
        bot.send_message(
            chat_id, 
            "ကျေးဇူးအများကြီးတင်ပါတယ် မိတ်ဆွေ! Feedback လေး ရရှိသွားပါပြီ။ ❤️", 
            reply_markup=get_main_menu()
        )
        return
